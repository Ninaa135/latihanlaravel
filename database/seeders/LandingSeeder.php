...
class LandingSeeder extends Seeder
{
    public function run(): void
    {
         ...
         * =============================== */
        $setting = [
            ['hero_title', 'Kampus Vokasi Terbaik Untuk Masa Depan Karir Anda', 'text'],
         ...
         * =========================== */
        $programs = [
            ['Administrasi Bisnis', 'Belajar pebgelolaan bisnis, administrasi perkantoran, dan dunia manajemen modern.', null, 1],

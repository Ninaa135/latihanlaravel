<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md mt-8">
        <h2 class="text-2xl font-semibold mb-4">e-KYC - Langkah 1: Data Pribadi</h2>
        ...
        <form action="{{ route('ekyc.storeStep1') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat" class="w-full border-gray-300 rounded-md p-2">{{ old('alamat', $ekyc->alamat ?? '') }}</textarea>
            </div>
